...
import CrudDrinkCard from './CrudDrinkCard';
...
const CrudDrink = () => {
    ...
    const DesrtMenuArr = drinkList.map(dish=>{
        return <CrudDrinkCard
        key={dish.id}
        img={imgStar}
        {...dish}/>
      })
      ...
      function handleSubmit(event){
          ...
          Axios.post('http://localhost:3001/api/insert/mainDish',{
